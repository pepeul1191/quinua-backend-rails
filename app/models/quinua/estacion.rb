...
class Quinua::Estacion
    ...
    def detalle(id)
        rpta = @db['
               SELECT IE.nombre_estacion, IE.descripcion, II.nombre_sensor, II.desc_instrumento, MTT.des_tipo FROM inve_estacion IE 
				...
				INNER JOIN mae_tablatipo_tipo MTT ON MTT.ide_tipo = II.tipo_unidad_medida
